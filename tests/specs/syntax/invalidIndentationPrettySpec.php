...
";
        ...
        $this->it("raises an error", function () {
            ...
            $this->expect(function () {
                ...
                $this->parser->parseString($this->input)->toPrettyHtml();

            })->to()->raise(
                NotUniqueIndentationCharError::class,
                function ($error) {
...
";
        ...
        $this->it("raises an error", function () {
            ...
            $this->expect(function () {
                ...
                IndentationCharMissmatchError::class,
                function ($error) {
...
";
        ...
        $this->it("raises an error", function () {
            ...
            $this->expect(function () {
                ...
                UnmatchedIndentationError::class,
                function ($error) {
...
";
        ...
        $this->it("raises an error", function () {
            ...
            $this->expect(function () {
                ...
                InvalidIndentationIncrementError::class,
                function ($error) {
